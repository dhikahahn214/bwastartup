...
func (r *repository) GetByUserID(userID int) ([]Transaction, error) {
	var transactions []Transaction // supaya gorm tau akan mencari data dari transaction
	// Query joint
...
func (r *repository) GetByID(ID int) (Transaction, error) {
	var transaction Transaction // supaya gorm tau akan mencari data dari transaction
